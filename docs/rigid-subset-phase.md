...
| Existing single-handle covariance | Reuses the validated six-dimensional map | Multiple carried bodies consistently narrow or rotate the useful docking basin |
